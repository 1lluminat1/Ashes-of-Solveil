...
label a2_s01_descent:
    $ show_timeline("8th of Ember, 385 A.C.", "04:00", "Aeries to Unders — Descent")
...
#   - Next: `a2_s02_reality_check` picks up inside the safehouse with exhaustion, rules of the Unders, and first real decompression.
