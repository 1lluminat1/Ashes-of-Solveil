...
label lore_lyra_the_band:
    ...
    l "(quiet) Then the Band rejects you. It heats until the metal blisters. The symbols crack and fade. And everyone in the room sees it happen."
    a "I remember."
    l "I know. I'm sorry I've never said that to you before."
    l "Aeron — there's something Elisse used to say about rejections. She studied them in the sealed wing before it collapsed."
    a "What did she say?"
    l "She said the Cathedral's word for rejection wasn't 'failure.' It was 'excess.' She never explained what she meant by that. The archives were sealed after Wing Seven."
    l "I've thought about it for years. I don't have an answer. But I don't think the word 'failure' is right either."
    a "Excess."
    l "(quiet) Excess. That's all I have. Elisse died before she could tell me more."
    return
...
label lore_selene_kael:
    ...
    sel "I saw him on the rail. I saw him go over. And something — I still don't know what — he didn't die."
