...
label a1_s11_hill_flashback:
    ...
    # SFX: Soft wind, far-off perimeter buzz, distant city hum. No rain (outside Aeries but clear sky).
    # FX/COMP: Subtle grain; chromatic warmth; grass ripple cards for parallax.
    # BLOCKING: Perimeter fence way off; scuffed Academy uniforms; blade of grass fidget prop.
    # FACE: Keep faces in profile for most of the scene; save direct eye-line for late "don't forget me."

    # ========= OPENING — ADULT REFLECTION =========
    ...
    athought "Years ago—before the Branding, before I became what I am, before everything broke."

    athought "We were both ten, two years before our Brandings would define us."

    athought "There was this hill, far enough for trouble, close enough to still matter. Rules never meant much to Lyra."
    ...
    ya "Better than being stuck in a crystal tower pretending it's perfect."

    yl "Crystal tower. I like that. Pretty, but cold."

    athought "She meant something sharper than she knew. Or maybe she always knew."

    ya "And it cuts if you're not careful."

    yl "(laughs) Everything in Aeries cuts if you're not careful."

    # ========= CONVERSATION — SILENCE VS NOISE =========
    ...
    # ========= CONVERSATION — AFTER THE BRANDING =========
    ...
    # CAMERA: 70mm insert on hands. Grass blades between fingers.
    ...
    athought "Even then, we were leaning toward each other. Close enough to touch, afraid of what touching might mean."
    ...
    # CAMERA: First direct eye-line of the scene. Hold it.

    "She pulls him up. For a moment, they stand too close—eyes meeting, holding."
...
#   - "Crystal tower" metaphor seeded (child's version of the theme); almost-touch motif mirrors Balcony.
