...
label act1_intro:
    ...
    "{i}The world ended in ash, and someone built upward to forget it.{/i}"
    "{i}Solveil—order stacked into the sky.{/i}"
    ...
    "{i}At the peak: the Aeries. Glass without dust. Light without warmth.{/i}"
    ...
    "{i}Echelon keeps the peace with pageantry and power—relics tamed into Aether Bands.{/i}"
    "{i}Some call them gifts. Others, shackles. Obedience makes the difference.{/i}"

    # VISUAL: Fade to black; single ember glows. 
    # Color shift from cold white to faint orange—symbol of hidden humanity.

    "{i}Not everything stayed buried.{/i}"
    "{i}Some truths wait in the glass for someone willing to look.{/i}"
